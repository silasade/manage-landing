...
import youtuber from './images/icon-youtube.svg'
        ...
        <footer className='footer'>
            ...
            <div >
                ...
                <Grid container spacing={4}>
                    <Grid item xs={6}>
                        <div className='first-link' style={{color:'hsl(13, 100%, 96%)'}}>
                    ...
                    <Grid item xs={6}>
                        <div className='second-link'>
                            ...
                            <NavLink className="NavLink" to="/Community">Privacy Policy</NavLink>
                        </div>
                    </Grid>
                </Grid>
                </Box>
